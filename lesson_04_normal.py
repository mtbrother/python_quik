...
pattern_mail = '([a-z_0-9]+@[a-z_0-9]+\.ru|org|com)'
print(name if re.match(pattern_name, name) != None else 'не правильно введено имя')
print(surname if re.match(pattern_name, surname) != None else 'не правильно введена фамилия')
print(email if re.search(pattern_mail, email) != None else 'не правильно введен email')
...
pattern_dots = '(\.\.+)'
print('Есть более одной точки подряд' if re.search(pattern_dots, some_str)
	!= None else 'нет более одной точки подряд')
